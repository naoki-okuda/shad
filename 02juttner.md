...
<!-- 
<img src="img/jut_gam_loglog.svg" alt="説明" width="1000" height="350"> -->
...
- 右辺は温度だけの関数である。以下に右辺を(T,V)のlog-logプロットで示す。Vは温度の単調減少関数で、$T/mc^2\sim0.2−0.3$付近からべき的な依存性が変化しているように見える。
これは比熱比$c_p/c_v$の変化として解釈できる。
